...
type TypeRemoveTodolistAction = {
    type:'REMOVE-TODOLIST'
    id:string
}
type TypeAddTodolistAction = {
    type:'ADD-TODOLIST'
    title:string
}
...
export function TodolistReducer (state:Array<ToDoListsType>,action:ActionType):Array<ToDoListsType>{
    switch (action.type) {
